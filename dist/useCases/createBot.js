...
const createBot = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        client.on("qr", (qr) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            }), 60 * 1000); // If after 60 seconds the client isn't connected, so the bot will be destroyed and deleted from the database
        ...
        server_1.io.on("order-confirm", (payload) => {
            if (payload.phone === client.info.wid.user) {
                client.sendMessage(payload.customerPhone, confirmMessage);
            }
        });
        server_1.io.on("delete-bot", (payload) => {
